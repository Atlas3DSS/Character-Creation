...
N_LAYERS = 36
HIDDEN_DIM = 4096
CONNECTOME_PATH = Path("./results/qwen_connectome/analysis/connectome_zscores.pt")
...
def run_eval(model, processor, layers, vectors, conditions: list[str],
             ...
             output_dir: Path = Path("./results/phase_aware_results"),
...
def main() -> None:
    ...
    if args.output:
        ...
        output_dir = Path(f"./results/phase_aware_results_{tag}")
