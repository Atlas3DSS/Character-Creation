...
Usage:
    python scripts/infra/orchestrate_overnight.py --pid 109827 [--phase3-budget 120]
"""
...
def main() -> None:
    ...
    if args.skip_35b:
        ...
        proc_35b = run_script(
            "python scripts/experiments/connectome/map_qwen35.py --model 35b --output ./qwen35_map",
            LOG_35B,
            "35B Phase 1+2+3+4"
        )
    ...
    if connectome_27b.exists() and n_27b_layers < 20:
        ...
        proc_fast_27b = run_script(
            f"python scripts/experiments/connectome/fast_layer_scan.py --model 27b --connectome {connectome_27b} "
    ...
    if connectome_35b.exists():
        ...
        proc_fast_35b = run_script(
            f"python scripts/experiments/connectome/fast_layer_scan.py --model 35b --connectome {connectome_35b} "
            f"--output ./qwen35_map --resume",
            LOG_FAST_35B,
            "35B fast scan"
        )
