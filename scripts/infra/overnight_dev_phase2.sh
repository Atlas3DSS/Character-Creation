...
#   nohup bash scripts/infra/overnight_dev_phase2.sh > overnight_phase2.log 2>&1 &
# ═══════════════════════════════════════════════════════════════════════════════
...
if [ -n "$PROBE_DIR" ]; then
    ...
    CUDA_VISIBLE_DEVICES=0 python3 -u scripts/experiments/sycophancy/sycophancy_steer_test_8b.py \
...
python3 -u scripts/experiments/arena/sycophancy_arena_8b.py \
...
python3 -u scripts/experiments/arena/debate_arena_v4.py \
