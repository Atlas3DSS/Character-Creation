...
#   nohup bash scripts/infra/overnight_local.sh > overnight_local.log 2>&1 &
# ═══════════════════════════════════════════════════════════════════════════════
...
python3 -u scripts/experiments/sycophancy/sycophancy_probe_27b.py --model base \
...
python3 -u scripts/experiments/sycophancy/sycophancy_probe_27b.py --model abliterated \
...
python3 -u scripts/sae/sae_collect_activations.py \
    --model base \
    --layers 50 44 36 16 \
    --max-tokens 500000 \
    --max-gen-tokens 256 \
...
python3 -u scripts/sae/sae_train.py \
    --layer 50 \
    --model-tag base \
    --total-steps 50000 \
    --batch-size 4096 \
