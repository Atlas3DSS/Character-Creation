...
#
# Usage:
#   nohup bash scripts/infra/queue_magnitude_sweep.sh > /tmp/queue_magnitude_sweep.log 2>&1 &
...
python -u scripts/experiments/connectome/magnitude_calibrated_steering.py \
    --alpha-base 5 8 12 \
    --scaling sqrt \
