...
#   nohup bash scripts/infra/overnight_dev.sh > overnight.log 2>&1 &
# ═══════════════════════════════════════════════════════════════════════════════
...
eval "$VENV"
CUDA_VISIBLE_DEVICES=0 python3 -u scripts/experiments/sycophancy/sycophancy_probe_8b.py \
...
CUDA_VISIBLE_DEVICES=1 python3 -u scripts/sae/sae_8b_pipeline.py train --layer 15 \
    > sae_train_L15.log 2>&1 &
PID_L15=$!

CUDA_VISIBLE_DEVICES=0 python3 -u scripts/sae/sae_8b_pipeline.py train --layer 29 \
...
CUDA_VISIBLE_DEVICES=1 python3 -u scripts/sae/sae_8b_pipeline.py train --layer 22 --gen-only \
    --output "$GENONLY_DIR/L22" > sae_train_L22_genonly.log 2>&1 &
PID_G22=$!

CUDA_VISIBLE_DEVICES=0 python3 -u scripts/sae/sae_8b_pipeline.py train --layer 9 --gen-only \
...
CUDA_VISIBLE_DEVICES=1 python3 -u scripts/sae/sae_8b_pipeline.py train --layer 15 --gen-only \
    --output "$GENONLY_DIR/L15" > sae_train_L15_genonly.log 2>&1 &
PID_G15=$!

CUDA_VISIBLE_DEVICES=0 python3 -u scripts/sae/sae_8b_pipeline.py train --layer 29 --gen-only \
