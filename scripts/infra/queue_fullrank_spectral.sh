...
#
# Usage: nohup bash scripts/infra/queue_fullrank_spectral.sh > /tmp/queue_fullrank_spectral.log 2>&1 &
...
python -u scripts/experiments/connectome/fullrank_spectral_analysis.py --resume 2>&1
