...
DEFAULT_OUTPUT = Path("./results/sycophancy_probe_27b_results")

# 27B connectome paths (qwen35_map is gitignored, stays at root)
CONNECTOME_BASE = Path("./qwen35_map/27b/connectome_zscores.pt")
CONNECTOME_ABLI = Path("./qwen35_map/27b-abliterated/connectome_zscores.pt")
