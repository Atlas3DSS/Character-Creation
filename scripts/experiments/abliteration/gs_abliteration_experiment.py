...
HUIHUI_CHECKPOINT_DEFAULT = "./results/abliteration_comparison/eval_checkpoint.json"
...
def main() -> None:
    ...
    parser.add_argument("--output", type=str, default="./results/gs_abliteration_results", help="Output directory")
