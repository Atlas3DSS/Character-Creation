...
def main() -> None:
    ...
    eval_h2h = (base / "eval_head_to_head.py").read_text()
    capture_steer = (base / "capture_and_steer_27b.py").read_text()
    ortho_sarc = (base / "orthogonal_sarcasm_steering.py").read_text()
