...
CONNECTOME_DEFAULT = "./qwen_connectome/analysis/connectome_zscores.pt"
...
def main() -> None:
    ...
    parser.add_argument("--output", type=str, default="./gs_abliteration_8b_results", help="Output directory")
